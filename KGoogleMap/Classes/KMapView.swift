...
@objcMembers public final class KMapViewCoordinator: NSObject, CLLocationManagerDelegate {
...
public struct KMapView: UIViewRepresentable {
    ...
    // Make coordinator
    public func makeCoordinator() -> KMapViewCoordinator {
        return KMapViewCoordinator(totalDistance: $totalDistance)
    }
